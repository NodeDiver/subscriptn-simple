  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">BTCPay Server Providers Dashboard</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">Manage your BTCPay Server infrastructure and monitor subscriptions</p>
        </div>
